...
public class BluetoothService extends Service {
    ...
    // 蓝牙已连接
    public final static String ACTION_GATT_CONNECTED = "cn.kanyun.phi_band.ACTION_GATT_CONNECTED";
    // 蓝牙已断开
    public final static String ACTION_GATT_DISCONNECTED = "cn.kanyun.phi_band.ACTION_GATT_DISCONNECTED";
    // 发现GATT服务
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "cn.kanyun.phi_band.ACTION_GATT_SERVICES_DISCOVERED";
    // 收到蓝牙数据
    public final static String ACTION_DATA_AVAILABLE = "cn.kanyun.phi_band.ACTION_DATA_AVAILABLE";
    // 连接失败
    public final static String ACTION_CONNECTING_FAIL = "cn.kanyun.phi_band.ACTION_CONNECTING_FAIL";
    // 蓝牙数据
    public final static String EXTRA_DATA = "cn.kanyun.phi_band.EXTRA_DATA";
